...
import heroImage from '../assets/Streetwear1.jpg'
import secondaryImage from '../assets/Streetwear2.jpg'
import monogram1 from '../assets/Streetwear3.jpg'
import monogram2 from '../assets/Streetwear4.jpg'
import lvMurakami from '../assets/Streetwear5.jpg'
import vvnTimeTrunk from '../assets/Streetwear6.jpg'

type StreetCategoryItem = {
  id: string
  label: string
  imageUrl: string
}
  ...
  return (
    <section className="w-full bg-paper text-ink" {...sectionProps}>
      ...
      <div className="mx-auto max-w-2xl px-5 py-10 text-center sm:px-8 sm:py-14">
        <p className="mx-auto max-w-xl text-sm text-ink/80 sm:text-base">{description}</p>
      </div>
